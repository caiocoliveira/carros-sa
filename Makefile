...
.PHONY: help test test-fast ingest extrair-laudo db-reset sheets triagem triagem-debug top empresas setup-cron worktree-new worktree-remove audit limpar-decoys verificar-laudos
...
help:
	...
	@echo "  make verificar-laudos              # audita completude de laudos ativos + auto-heal"
...
verificar-laudos:
	$(PY) scripts/verificar_laudos.py --empresa $(or $(EMPRESA),carros_uberlandia)
