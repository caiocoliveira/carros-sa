...
.PHONY: help test test-fast ingest extrair-laudo db-reset sheets triagem triagem-debug top empresas setup-cron worktree-new worktree-remove audit limpar-decoys auditar-laudos sync-laudos-drive
...
help:
	...
	@echo "  make sync-laudos-drive [EMPRESA=<id>] # sobe PDFs locais pro Drive e persiste link permanente"
...
sync-laudos-drive:
	$(PY) scripts/sync_laudos_drive.py $(if $(EMPRESA),--empresa $(EMPRESA),)
