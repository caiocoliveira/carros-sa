...
.PHONY: help test test-fast ingest extrair-laudo db-reset sheets triagem triagem-debug top empresas setup-cron worktree-new worktree-remove audit audit-laudos limpar-decoys
...
help:
	...
	@echo "  make audit-laudos [EMPRESA=<id>]   # lista lotes ativos sem laudo bom"
...
audit-laudos:
	$(PY) -m carros_sa.cli audit-laudos --empresa $(or $(EMPRESA),carros_uberlandia)
