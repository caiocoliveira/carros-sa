...
# (3) retry automático de laudos pendentes → (4) audit estrito final.
#
...
#
# (4) audit `--strict`: fecha o laço. Se algum lote ativo ainda está sem PDF
# baixado / cache forte / URL clicável depois das 3 etapas anteriores, o
# script sai com exit 1 e o cron loga "exit code != 0". Esse é o sinal pro
# operador olhar o log — sem ele, a planilha continuaria mostrando
# "⚠ LAUDO NÃO CAPTURADO" silenciosamente até alguém reparar manualmente.
...
echo "  Comando: triagem + limpar_decoys + retry de laudos pendentes + audit --strict"
echo "  Log:     $LOG"
echo ""
